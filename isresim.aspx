<%@ Page Title="" Language="C#" MasterPageFile="~/jeweler-master/Admin.Master" AutoEventWireup="true" CodeBehind="isresim.aspx.cs" Inherits="Aksan2.jeweler_master.isresim" %>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="sparkline10-list shadow-reset">
                        ...
                        <div class="single-new-trend mg-t-30">
                            <a href="#"> <asp:Image ID="is_resimler" ImageUrl='<%#Eval("ResimUrl")%>' runat="server" /></a>
                            <div class="overlay-content">
                                
                                <a href="#" class="btn-small">diğer resimler</a>
                                <div class="product-action">
                                    <ul>
                                        <li>
                                            <a data-toggle="tooltip" title="sil" href='isresim.aspx?ResimId=<%#Eval("ResimId") %>&islem=sil'><i class="fa fa-close" aria-hidden="true"></i></a>
                                        </li>
