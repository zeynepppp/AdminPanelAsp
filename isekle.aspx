<%@ Page Title="" Language="C#" MasterPageFile="~/jeweler-master/Admin.Master" AutoEventWireup="true" CodeBehind="isekle.aspx.cs" Inherits="Aksan2.jeweler_master.isekle" %>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                <ul id="myTab3" class="tab-review-design">
                                    <li class="active"><a href="#description"><i class="fa fa-pencil" aria-hidden="true"></i>İş Ekle</a></li>
                                                ...
                                                <div class="review-content-section">
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <%--<input type="text" class="form-control" placeholder="Product Title">--%>
                                                         <CKEditor:CKEditorControl ID="txt_ozet" runat="server">özet</CKEditor:CKEditorControl>  
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-usd" aria-hidden="true"></i></span>
                                                       <%-- <input type="text" class="form-control" placeholder="Regular Price">--%>
                                                        <CKEditor:CKEditorControl ID="txt_icerik" runat="server">içerik</CKEditor:CKEditorControl>
                                                    </div>
