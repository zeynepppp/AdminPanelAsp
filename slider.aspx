<%@ Page Title="" Language="C#" MasterPageFile="~/jeweler-master/Admin.Master" AutoEventWireup="true" CodeBehind="slider.aspx.cs" Inherits="Aksan2.jeweler_master.slider" %>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="sparkline10-list shadow-reset">
                        ...
                        <div class="single-new-trend mg-t-30">
                            ...
                            <a href="#"> <asp:Image ID="is_resimler" ImageUrl='<%#Eval("SliderResim")%>' runat="server" /></a>
                            <div class="overlay-content">
                                
                                <a href="#" class="btn-small">Slider</a>
                                <div class="product-action">
                                    <ul>
                                        <li>
                                            <a data-toggle="tooltip" title="sil" href='slider.aspx?SliderId=<%#Eval("SliderId") %>&islem=sil'><i class="fa fa-close" aria-hidden="true"></i></a>
                                        </li>
